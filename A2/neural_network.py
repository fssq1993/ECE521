...
def run(lr, lam, batch_size, num_epoch):
    ...
    for i in xrange(num_epoch):
        ...
        for step in xrange(num_steps):
            ...
            # print("Epoch: %3d, Iter: %3d, Loss-train: %4.2f, Train Accuracy: %4.2f"
            # % (i, step, errTrain, train_accuracy))
        ...
        if i == 5 or i == 10 or i == 15 or i == 20:
            save_path = saver.save(sess, "/home/yuanyi/ECE521/A2/neural_network/model"+str(i)+".ckpt")
